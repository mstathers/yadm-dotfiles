...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="michael"
...
# air.sh {
	...
	TMUX_POWERLINE_SEG_AIR_LAT="50.676109"
	TMUX_POWERLINE_SEG_AIR_LON="-120.340836"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/mstathers/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/mstathers"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/mstathers/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/mstathers/.now_playing.log"
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="50.676109"
	TMUX_POWERLINE_SEG_WEATHER_LON="-120.340836"
# }
